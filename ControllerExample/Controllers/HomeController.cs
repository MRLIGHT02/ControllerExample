...
namespace ControllerExample.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            return new VirtualFileResult(@"/Profile.pdf", "application/pdf");
        }
        [Route("/mine-file")]
        public PhysicalFileResult Physical()
        {
            return PhysicalFile(@"C:\Users\user\Desktop\Pro.ASP.NET.Core.6.9th.Edition.Adam.Freeman.Apress.9781484279564.EBooksWorld.ir.pdf", "application/pdf");
        }

        [Route("/mine-file2")]
        public FileContentResult MYconte()
        {
            byte[] bytes = System.IO.File.ReadAllBytes(@"C:\Users\user\Desktop\Pro.ASP.NET.Core.6.9th.Edition.Adam.Freeman.Apress.9781484279564.EBooksWorld.ir.pdf");
